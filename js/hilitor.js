...
function Hilitor2(id, tag)
{
  ...
  function addAccents(input)
  {
    ...
    retval = retval.replace(/\\u00F1/ig, "n");
    retval = retval.replace(/a/ig, "([aáàâä]|ae)");
    retval = retval.replace(/c/ig, "[cç]");
    retval = retval.replace(/e/ig, "[eéèêë]");
    retval = retval.replace(/i/ig, "[iíîï]");
    retval = retval.replace(/o/ig, "([oóôö]|oe)");
    retval = retval.replace(/u/ig, "[uúùûü]");
